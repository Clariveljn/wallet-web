...
<title>Alke-Wallet-Deposit</title>
</head>
<body>
	...
	<div class="container mt-4 mx-auto">
		...
		<div class="card p-3 mx-auto mt-4 text-center">
			...
			<form action="${pageContext.request.contextPath}/DepositarServlet"
				method="post">

				<input type="hidden" name="idCuenta" value="<%=idCuenta%>">
				<label for="montoDepositar">Monto a Depositar:</label><br> 
				<input
					type="number" step="0.01" id="montoDepositar" name="montoDepositar" required><br> 
				<input type="submit" class="btn btn-info btn-lg p-2 mt-4 d-block mx-auto" value="Depositar">
			</form>
			<div id="amountInvalid" class="alert alert-danger text-center mt-3"
				role="alert" style="display: none"></div>

			<div id="mensajeDeposito" class="alert alert-info text-center mt-3"
				role="alert" style="display: none"></div>
		</div>
	</div>
	...
	<script src="${pageContext.request.contextPath}/js/deposit.js"></script>
</body>
</html>