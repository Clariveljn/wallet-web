...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav fs-5 ms-auto">
					<a class="nav-link me-4"
						href="${pageContext.request.contextPath}/pages/login.jsp">Iniciar
						sesión</a>
				</div>
			</div>
		</div>
	...
	<div class="container mt-4">
		...
		<form action="${pageContext.request.contextPath}/RegistroServlet" method="post">
			...
			<input type="text" id="nombre" name="nombre" class="mb-2" required><br>
			<label for="apellido">Apellido:</label> <br>
			<input type="text" id="apellido" name="apellido" class="mb-2"required><br>
			<label for="email">Email:</label> <br>
			<input type="email" id="email" name="email" class="mb-2" required><br>
			<label for="password">Contraseña:</label> <br>
			<input type="password" id="password" name="password" required><br>
			<input type="submit" class="btn btn-info btn-lg p-2 mt-4 d-block mx-auto" value="Registrar">
		</form>
		</div>
